...
public class CreateDemo {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            // create the objects
            Instructor tempInstructor = new Instructor("Mike", "Phillips", "MikePh@yahoo.com");

            InstructorDetail tempInstructorDetail = new InstructorDetail("youtube.com/MPLife", "Tennis");
